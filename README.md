...
To work around this, you can use the `ParseGoTestFlags` function, which ensures that go test's flags are parsed separately using the standard flag package.
...
func main() {
	flag.CommandLine.AddGoFlagSet(goflag.CommandLine)
    flag.ParseGoTestFlags(os.Args[1:], goflag.CommandLine)
	flag.Parse()
}
```
