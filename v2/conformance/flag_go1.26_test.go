//go:build conformance && go1.26 && !go1.27

// Code generated by conformance/hack/sync.sh from the Go standard library's
// flag package test suite (src/flag/flag_test.go) at go1.26. DO NOT EDIT.
//
...
// go1.26 toolchain so the CI matrix tests each supported Go release against
...
func init() { vendoredVersion = "go1.26" }
