//go:build conformance && go1.25 && !go1.26

// Code generated by conformance/hack/sync.sh from the Go standard library's
// flag package test suite (src/flag/flag_test.go) at go1.25. DO NOT EDIT.
//
...
// go1.25 toolchain so the CI matrix tests each supported Go release against
...
import (
	...
	"github.com/spf13/pflag/v2/conformance/internal/testenv"
	"io"
	"os"
	"os/exec"
	"regexp"
...
// Register this vendored copy with the guard in harness_test.go so an
// un-synced Go toolchain fails loudly instead of silently testing nothing.
func init() { vendoredVersion = "go1.25" }
