...
const (
	...
	ExitOnError
	PanicOnError
	WordSeparatorNormalizeKey = "pflag.WordSeparatorNormalizeFuncKey"
)
...
func WordSeparatorsNormalizeFunc(f *FlagSet, name string) NormalizedName {
	result := name
	for _, sep := range f.Annotations[WordSeparatorNormalizeKey] {
